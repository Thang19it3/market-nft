...
class App extends Component {
	...
	createProduct(name, price, img, pk) {
		this.setState({ loading: true })
		this.state.marketplace.methods.createProduct(name, price, img, pk).send({ from: this.state.account })
							...
							return (
								<div>
									...
									<div div className = "container-fluid app">
										<div className="row">
											<main role="main" className="col-lg-12" style={{padding:'0px 0px',margin:'0px 0px'}}>
											{ this.state.loading
